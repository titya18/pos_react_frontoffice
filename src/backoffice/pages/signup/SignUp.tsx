...
const SignUp: React.FC = () => {
    ...
    const mutation = useMutation(apiClient.signUp, {
        ...
        onError: async () => {
            ...
            // showToast({ message: "Email already exist", type: "ERROR" });
        }
    });
        ...
        <div className="main-container min-h-screen text-black dark:text-white-dark">
            ...
            <div>
                <div className="absolute inset-0">
                    <img src="/admin_assets/images/auth/bg-gradient.png" alt="image" className="h-full w-full object-cover" />
                </div>
                <div
                ...
                >
                    <img src="/admin_assets/images/auth/coming-soon-object1.png" alt="image" className="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                    <img src="/admin_assets/images/auth/coming-soon-object2.png" alt="image" className="absolute left-24 top-0 h-40 md:left-[30%]" />
                    <img src="/admin_assets/images/auth/coming-soon-object3.png" alt="image" className="absolute right-0 top-0 h-[300px]" />
                    <img src="/admin_assets/images/auth/polygon-object.svg" alt="image" className="absolute bottom-0 end-[28%]" />
                    <div
                    ...
                    >
                        <div
                            className="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]"
                        >
                            <div
                            ...
                            <div className="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="index-2.html" className="block w-48 lg:w-72 ms-10">
                                    <img src="/admin_assets/images/auth/logo-white.svg" alt="Logo" className="w-full" />
                                </a>
                                <div className="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src="/admin_assets/images/auth/login.svg" alt="Cover Image" className="w-full" />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="w-full max-w-[440px] lg:mt-16">
                                ...
                                <form className="space-y-5 dark:text-white" onSubmit={onSubmit}>
                                    <div className="flex space-x-4">
                                        <div className="w-1/2">
                                            ...
                                            <div className="relative text-white-dark">
                                                <input type="text" placeholder="Enter First Name" className="form-input ps-10 placeholder:text-white-dark" 
                                    ...
                                    <div>
                                        ...
                                        <div className="relative text-white-dark">
                                            <input type="text" placeholder="Enter Phone Number" className="form-input ps-10 placeholder:text-white-dark" 
                                                {...register("phoneNumber", {required: "This field is required"})} />
                                            <span className="absolute start-4 top-1/2 -translate-y-1/2">
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                                <path d="M6.62 10.79C8.06 13.61 10.39 15.94 13.21 17.38L15 15.59C15.27 15.32 15.66 15.23 15.99 15.33C17.3 15.73 18.72 15.99 20.25 15.99C20.66 15.99 21 16.33 21 16.74V20.25C21 20.66 20.66 21 20.25 21C10.2 21 3 13.8 3 3.75C3 3.34 3.34 3 3.75 3H7.26C7.67 3 8.01 3.34 8.01 3.75C8.01 5.28 8.27 6.7 8.67 8.01C8.76 8.34 8.68 8.73 8.41 9L6.62 10.79Z" fill="#888EA8"/>
                                            </svg>
                                            </span>
                                        </div>
                                        {errors.lastName && (
                                    ...
                                    <div>
                                        ...
                                        {errors.email && (
                                            <p className='error_validate'>{errors.email.message}</p>
                                        )}
                                    </div>
                                    <div>
                                        <label>Password</label>
                                        <div className="relative text-white-dark">
                                            <input type="password" placeholder="Enter Password" className="form-input ps-10 placeholder:text-white-dark"
                                                {...register("password", {
                                        ...
                                        {errors.password && (
                                            <p className='error_validate'>{errors.password.message}</p>
                                        )}
                                    </div>
                                    <div>
                                        <label>Confirm Password</label>
                                        <div className="relative text-white-dark">
                                            <input type="password" placeholder="Enter Confirm Password" className="form-input ps-10 placeholder:text-white-dark"
                                        ...
                                        {errors.confirmPassword && (
                                            <p className='error_validate'>{errors.confirmPassword.message}</p>
                                        )}
                                    </div>
                                    <div>
                                    ...
                                    <button type="submit" className="btn btn-gradient !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px_rgba(67,97,238,0.44)]" disabled={mutation.isLoading}>
                                        {mutation.isLoading ? "Signin Up..." : "Sign Up"}
                                    </button>
                                </form>
                                ...
                                {/* <div className="mb-10 md:mb-[60px]">
                                    <ul className="flex justify-center gap-3.5">
                                        <li>
                                            <a
                                                href=""
                                                className="inline-flex h-8 w-8 items-center justify-center rounded-full p-0 transition hover:scale-110 icon_style"
                                            >
