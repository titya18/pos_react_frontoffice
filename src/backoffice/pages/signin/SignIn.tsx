...
const SignIn: React.FC = () => {
    ...
    const mutation = useMutation(apiClient.signIn, {
        onSuccess: async () => {
            ...
            //     autoClose: 2000,
            // });
            // Store a flag in sessionStorage to trigger a toast after page load
                                ...
                                <form className="space-y-5 dark:text-white" onSubmit={onSubmit}>
                                    <div>
                                        ...
                                        <div className="relative text-white-dark">
                                            <input id="Email" type="email" placeholder="Enter Email" autoFocus className="form-input ps-10 placeholder:text-white-dark"
                                                {...register("email", {
